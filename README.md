...
<img src='./media/icon.png' width='90' alt='Arm CMSIS SDS Tools' align='left' />VS Code extension for Arm Synchronous Data Stream (SDS) — record, view, and export sensor data using workspace-based configuration.
